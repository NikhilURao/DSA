...
public class RightView {
	...
	public ArrayList<Integer> showRightView(BTNode root){
		...
		if (root == null) return new ArrayList<Integer>();
			...
			// only take the last element in each list. last element in the list of level order traversal represents the right view of BT
			ArrayList<Integer> out = new ArrayList<>();
			for (int i=0; i<ls.size(); i++) {
				ArrayList<Integer> level = ls.get(i);
	...
	public static void main(String[] args) {
		...
		ArrayList<Integer> out = rv.showRightView(root);
